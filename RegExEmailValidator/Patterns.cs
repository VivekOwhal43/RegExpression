...
namespace RegExEmailValidator
{
    public class Patterns
    {
        ...
        public static string email_Validator ="^[0-9a-zA-Z]+[./+_-]{0,1}[0-9a-zA-Z]+[@][a-zA-Z0-9-]+[.][a-zA-Z]{2,}([.][a-zA-Z]{2,}){0,1}$";
        ...
        public bool emailValidator(string email)    // method for validating last name
        {
